...
> [!NOTE]
> Made in collaboration with [@orowicki](https://github.com/orowicki).
...
- Należy zastosować zasadę *perfect forwarding* przy wykonywaniu `std::invoke`.
...
Przykłady użycia znajdują się w pliku `invoke_forall_example.cpp`.
